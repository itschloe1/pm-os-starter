...
First, read the ICP document at `context-library/strategy/icp-dataspace-creator-2026Q1.md` to ground your perspective in the real target user profile (demographics, JTBD, pain points, behaviors).
