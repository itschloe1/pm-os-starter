...
**참조:** `/launch-checklist` 스킬로 체크리스트 생성
...
[1] 론치 계획 정리                             론치 계획서               PM
    ...
    - 용어 정의
    - 다른 론치와의 순서/경계
[2] Comms doc 작성                            Comms doc               PM
    - 외부 메시징, 포지셔닝, FAQ
[3] MKT 핸드오프                              Product Marketing Plan   MKT
[4] CS팀 브리핑                                브리핑 자료              PM
[5] Sales Brief 작성                          Sales Brief             PM
[6] 약관 변경 고지 (해당 시, 14일 전)            고지 내용               Legal + PM
[7] 고객 이메일/인앱 안내 준비                   이메일 초안              MKT + PM
[8] 내부 전사 공지 준비                         공지 초안                PM

[D-day]
[9] Feature flag 활성화                                                Eng
[10] 실시간 모니터링 시작                                               PM + Data
[11] CS 모니터링                                                       CS
[12] 론치 comms 발송                                                   MKT
```
...
**참조:** `/sales-brief`, `/slack-message`, `/status-update` 스킬 활용
...
| 검증 | `/launch-checklist` |
| 론치 | `/sales-brief`, `/slack-message`, `/status-update`, `/gtm-brief` |
